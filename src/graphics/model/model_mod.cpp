...
void ConvertOldTex1Name(ModelTriangle& triangle, const char* tex1Name)
{
    ...
    triangle.material.albedoTexture = StrUtils::Replace(triangle.material.albedoTexture, "bmp", "png");
    triangle.material.albedoTexture = StrUtils::Replace(triangle.material.albedoTexture, "tga", "png");
}
